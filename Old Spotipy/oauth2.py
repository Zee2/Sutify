...
class SpotifyOAuth(object):
    ...
    def get_authorize_url(self):
        ...
        payloadList = [('redirect_uri', self.redirect_uri), ('client_id', self.client_id), ('response_type', 'code')]
        ...
        if self.scope:
            payloadList.append(('scope', self.scope))

        urlparams = urllibparse.urlencode(payload)
        #urlparams = urllibparse.urlencode(payloadList)
